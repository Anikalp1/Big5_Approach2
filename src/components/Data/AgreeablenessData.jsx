const AgreeablenessData = {
  ...
  series: [14, 13, 16, 12, 4, 14],
};

const Explanation = (
  <p>
    They are therefore considerate, friendly, generous, helpful, and willing
    to compromise their interests with others'. Agreeable people also have an
    ...
    the other hand, agreeableness is not useful in situations that require
    tough or absolute objective decisions. Disagreeable people can make
...
export { AgreeablenessData, Explanation };
