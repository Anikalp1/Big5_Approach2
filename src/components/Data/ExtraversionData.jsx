...
const Explanation = (
  <p>
    ...
    agreeableness dimension will not seek others out but will be quite pleasant
    when approached.
    <br />
    <br />
    Your score on Extraversion is low, indicating you are introverted, reserved,
    and quiet. You enjoy solitude and solitary activities. Your socialization
    tends to be restricted to a few close friends.
  </p>
);

export { ExtraversionData, Explanation };
