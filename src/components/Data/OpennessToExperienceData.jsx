const OpennessToExperienceData = {
  ...
  series: [19, 9, 15, 13, 13, 12],
};

const Explanation = (
  <p>
    Open people are intellectually curious, appreciative of art, and sensitive
    ...
    to experience. Scores on Openness to Experience are only modestly related to
    ...
    or one of the many visual or performing arts.
    <br />
    <br />
...
export { OpennessToExperienceData, Explanation };
